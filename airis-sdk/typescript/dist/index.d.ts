...
export declare class Websocket {
     ...
     *                   服务器不会包含这个字段.
     */
    startup(gameName: string): Promise<void>;
    /**
     ...
     */
    sendContext(message: string, silent?: boolean): Promise<void>;
    /**
     ...
     */
    unregisterActions(actionNames: string[]): Promise<void>;
    /**
     ...
     */
    forceActions(query: string, actionNames: string[], state?: string, ephemeralContext?: boolean, priority?: "low" | "medium" | "high" | "critical"): Promise<void>;
    /**
     ...
     */
    sendActionResult(actionId: string, success: boolean, message?: string): Promise<void>;
    /**
